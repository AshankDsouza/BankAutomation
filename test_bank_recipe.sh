...
npx tsx Discovery.ts "https://www.ngpf.org/bank-sim/" "add new recipients named Adam, Cane and Abel"



npx tsx Discovery.ts "https://www.ngpf.org/bank-sim/" "add new recipient named Dr. Watson"
